...
$query = "SELECT tb.id_buku, tb.id_user, tb.id_kategori, tb.nama_buku, tb.desc_buku, tb.foto_buku, tb.insert_time, tb.view, tk.nama_kategori, tu.nama_user FROM tb_user tu, tb_buku tb, tb_kategori tk WHERE tu.id_user = tb.id_user && tk.id_kategori = tb.id_kategori ORDER BY tb.id_buku DESC";
